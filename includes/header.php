...
(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Message,Password,status)
VALUES
(:fullname,:mobileno,:emailid,:age,:gender,:bloodgroup,:address,:message,:password,:status)";
